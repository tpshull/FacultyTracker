...
body{
	background-color: rgb(40, 14, 157); /* #044D98;#001B38; aggie blue */
...
#header{
	background:rgba(253, 185, 39, 0.98);
	position:relative;
	width: 100%;
	top: 0;
	left: 0;
...
<form name="Date" action="week.php" method="post">
...
?>
    ...
    <ul>
    <li>
	<a href="Administrator.html">Back to Faculty Page </a> </li>
...
setInterval("getthedate()",1000)
  ...
  <span id="clock"></span>
  <div id="footer">
    	<labeL> Brought to you by RTG Spring' 2015 </labeL>
    </div> <!--End footer-->
</body>
</html>