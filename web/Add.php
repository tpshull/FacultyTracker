...
<p>Please fill out each field for adding an appointment. </p>
<hr>
</div>
...
function addEnd()
{
	document.getElementByName("EndDate").disabled=false;
}
...
<form name="Appointment" action="AddAppointment.php" method="post">
  ...
  <p>
    ...
    <label for="STime">From: 
      <select value="<?php echo htmlspecialchars(date("H:i")); ?>" name="STime" id="select">
      <script type="text/javascript">
	  var init = 5;
	  ...
	  for(init; init < 24; init++)
	  {
		  ...
		  if(init <= 11)
		  {
			  ...
			  document.write("<option value=" + init + ":00:00>" + init + ":00 pm</option>");
			  document.write("<option value=" + init + ":30:00>" + init + ":30 pm</option>");
		  }
	  ...
	  for(init2; init2 < 24; init2++)
	  {
		  ...
		  if(init2 <= 11)
		  {
			  ...
			  document.write("<option value=" + init2 + ":00:00>" + init2 + ":00 pm</option>");
			  document.write("<option value=" + init2 + ":30:00>" + init2 + ":30 pm</option>");
		  }
		  else
		  {
  ...
  <label> Repeats: 
  <select onchange="addEnd()" name="Repeat">
  ...
  <option value="2">Daily</option>
    ...
    <label> End Date:
      <input name="EndDate" value="<?php echo htmlspecialchars(date("Y-m-d"));?>" style="cursor: text" onfocus="ds_sh(this);" onclick="ds_sh(this);"/>
  </label>
  <p>
    <label>Location:
  ...
  <label>
    <input type="button" name="close" id="closebtn" value="Cancel" onClick="window.close()"/>
  </label>
  </p>
</p>
</form>
